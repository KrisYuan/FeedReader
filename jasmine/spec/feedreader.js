    ...
    */
    ...
    describe('The menu',function() {
         ...
         */
          ...
          */
          it('should show the menu when menu icon is clicked',function() {
    ...
    describe('New Feed Selection', function() {
        ...
        beforeEach(function(done) {
            loadFeed(0, function() {
                initialValue = $('.feed').html();
                done();
            });
        });


        it('should not have the same content after the feed is loaded again', function(done) {
            loadFeed(1, function() {
                changedValue = $('.feed').html();
                expect(changedValue).not.toEqual(initialValue);
                done();
            });
        });
